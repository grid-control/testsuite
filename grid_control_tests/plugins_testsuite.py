...
class TestsuiteAbortLocalEventHandler(LocalEventHandler):
...
class TestsuiteAbortRemoteEventHandler(RemoteEventHandler):
	def __init__(self, config, name):
		RemoteEventHandler.__init__(self, config, name)
		abort(True)


class TestsuiteRemoteHandler(RemoteEventHandler):
...
class TestsuiteWMS(WMS.get_class('BasicWMS')):
