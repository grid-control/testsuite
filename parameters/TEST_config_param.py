...
class Test_ParameterConfigInline:
	...
	['123 456']
	>>> test_get_parameter('test', {'test': '123 456', 'test source': 'A', 'test type': 'format'})
	('FormatterParameterSource', 'test', '123 456', 'A', '')
	>>> test_get_parameter('test', {'test': '123 456', 'test type': 'transform'})
	('TransformParameterSource', 'test', '123 456', '')
