...
class Test_BasicParameterSource:
	...
	>>> try_catch(lambda: testPS(ParameterSource.create_instance('SimpleParameterSource', 'KEY', None)), 'ConfigError', 'Missing values')
	caught
	...
	... [{'CPUTIME': '10:00'}, {'MEMORY': '2000'}, {'WALLTIME': '0:00:10'}], [ParameterMetadata('CPUTIME')])
	...
	ZIP(<internal:CPUTIME=46594f318266fdde630bbcf86edaa1a5>, req())
	85a8bfeba501a5194577fbf847c13c80
	3
	Keys = GC_PARAM
	...
	>>> ps = ParameterSource.create_instance('InternalNestedParameterSource', [])
	>>> try_catch(lambda: ps.get_nested(ps), 'AbstractError')
	caught

	>>> try_catch(lambda: ParameterSource.create_instance('RedirectorParameterSource'), 'APIError')
	caught

	>>> p1 = ParameterSource.create_instance('InternalParameterSource',
	... [{'A': '123'}, {'A': '456'}], [ParameterMetadata('A')])
	>>> pt = ParameterSource.create_instance('TransformParameterSource', 'B', 'A+2')
	>>> testPS(ParameterSource.create_instance('ZipLongParameterSource', p1, pt))
	ZIP(<internal:A=9a2e48d982bf187dd20f084b3f2c68e9>, transform('B', 'A+2', ''))
	b44811f1ffc73f01a57c20e37be44268
	2
	Keys = A [trk], B, GC_PARAM
	0 {'<ACTIVE>': True, '<REQS>': [], 'A': '123', '!B': 125, '!GC_PARAM': 0}
	1 {'<ACTIVE>': True, '<REQS>': [], 'A': '456', '!B': 458, '!GC_PARAM': 1}
	redo: [] disable: [] size: False
	...
	1 {'<ACTIVE>': True, '<REQS>': [], 'A': '456', '!B': '555', '!GC_PARAM': 1}
	redo: [] disable: [] size: False
...
class Test_MultiParameterSource:
	...
	>>> p0.get_psrc_hash()
	''
	>>> ParameterSource.create_instance('MultiParameterSource', p0, p0, p0)
	null()
